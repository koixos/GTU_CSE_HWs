...
/**
 * A class for visualizing data in a graphical user interface.
 * This class extends JFrame and provides functionality to plot data points in line or scatter plot format.
 */
public class GUIVisualization extends JFrame {
    ...
    /**
     * Constructs a new GUIVisualization frame.
     * @param plotType The type of plot to create ("line" or "scatter").
     * @param title The title of the window.
     * @param numberTrials The number of trials used to generate data points.
     * @param timeDuration The base time duration used to generate y-axis data points.
     */
    public GUIVisualization(String plotType, String title, int numberTrials, long timeDuration) {
        ...
        for (int i = 1; i <= 10; i++) {
            dataPointsX.add(i * numberTrials); // Add sample x-axis data points
            dataPointsY.add((long) (Math.log(i * timeDuration) * timeDuration)); // Add sample y-axis data points reflecting O(log n)
        }
    ...
    /**
     * Paints the component by calling the superclass's paint method and drawing the graph.
    ...
    /**
     * Draws the graph on the provided Graphics object.
